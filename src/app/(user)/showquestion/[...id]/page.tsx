...
const QuesWithImage = () => {
  ...
  useEffect(() => {
    // Play continuous background music when the quiz starts
    backgroundMusicRef.current.loop = true;
    backgroundMusicRef.current.play();

    // Cleanup function to stop the music when the component unmounts or quiz ends
    return () => {
      backgroundMusicRef.current.pause();
      backgroundMusicRef.current.currentTime = 0; // Reset audio to the beginning
    };
  }, []);
  ...
  const finishQuiz = () => {
    ...
    router.push(
      `/quizfinish?correct=${correctCount}&wrong=${wrongCount}&points=${points}`
    );
              ...
              {Array.isArray(questions) &&
                ...
                (questions[currentQuestionIndex].imageUrl ? (
                  ...
                  <div style={{ width: "100%", height: "100px" }}>
                    ...
                    {/* You can add more content or leave it empty based on your requirement */}
                  </div>
                ))}
            </div>
            <div className="quesPadding">
              ...
              <div className="quesHeadingDiv pt-10">
                {currentQuestionIndex < questions.length && (
                  <motion.h1
                    key={currentQuestionIndex}
