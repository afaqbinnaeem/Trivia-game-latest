            ...
            {quizes?.map((quiz) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* <p className="text-center pt-4 startDate">
                    ...
                    <h1 className="hhquizHeading mt-5 pt-14">
                      {quiz.quizName}
                    </h1>
                    {/* {alltournments && alltournments.length > 0 && (
                      <h4 className="hQuizHeadingTwo">
                        1st wins {alltournments[0].firstPrize}
                      </h4>
                    )} */}
                    <div className="quizFooter mt-5 flex items-center justify-around pt-14">
